...
def main():
    ...
    lambda_update = lambda: update_button_states(
        ...
        run_button, update_contacts_var, update_transfer_journal_var,plan_var,tax_var,exchange_rate_var,user_var
    )
    ...
    update_contacts_checkbox, run_button, update_contacts_var, update_transfer_journal_checkbox, update_transfer_journal_var,plan_checkbox, plan_var,tax_checkbox,tax_var,exchange_rate_checkbox,exchange_rate_var,user_checkbox,user_var = setup_checkboxes_and_run_button(
    ...
    exchange_rate_checkbox.config(command=lambda_update)
    user_checkbox.config(command=lambda_update)
